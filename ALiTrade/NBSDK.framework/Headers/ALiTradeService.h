...
#import "ALiTradeResult.h"
#import "ALiTradeTaokeParams.h"
#import "ALiTradePageFactory.h"
#import "ALiTradeShowParams.h"
...
typedef void (^tradeProcessSuccessCallback)(ALiTradeResult * __nullable result);
...
/** 交易服务 */
@protocol ALiTradeService <NSObject>
/**
...
- (NSInteger)                show:(UIViewController * __nonnull)parentController
                        page:(id<ALiTradePage> __nonnull)page
                    showParams:(nullable ALiTradeShowParams*)showParams
                 taoKeParams:(nullable ALiTradeTaokeParams *)taoKeParams
                  trackParam:(nullable NSDictionary*)trackParam
 tradeProcessSuccessCallback:(nullable void (^)(ALiTradeResult * __nullable result))onSuccess
